...
const Dashboard = (props) => {
    ...
    const searchInput = (data) => {
        ...
        if (data === null || data === "") {
            ...
            const filterData = selectedResult.filter((x) => x.name.match(data));
            setSelectedResult(filterData);
        }
    };
    ...
    return (
        <div className={classes.container}>
            ...
            <SpecificSearch onUserInput={searchInput} />
            <SearchResult results={selectedResult} />
        </div>
    );
};
